            ...
            >
                <div>
                    ...
                    <div className="settings-container">
                        ...
                        <div onClick={this.handlePrivacyClick} className="settings-grid"><IconButton><LockIcon fontSize="large"/></IconButton><h4 className="item">Privacy</h4><p>Location, camera, microphone</p></div>
                    ...
                    {this.state.isPrivacyClicked &&
                        <div className="privacy-container">
                            <div className="privacy-drawer">
                                ...
                                <div id="cloud" onClick={this.handleCloudClick} className="privacy-grid" style={{ backgroundColor: this.state.color }}><IconButton><CloudIcon fontSize="large"/></IconButton><p className="item">Cloud</p></div>
                            ...
                            {this.state.isCloudClicked ?
                                <div>
                                    ...
                                    <FormControlLabel control={<Checkbox checked={true}/>} label="Mail"/><br/>
                                    <FormControlLabel control={<Checkbox checked={true}/>} label="Contacts"/><br/>
                                    <FormControlLabel control={<Checkbox checked={true}/>} label="Calendars"/><br/>
                                    <FormControlLabel control={<Checkbox checked={true}/>} label="Reminders"/><br/>
                                    <FormControlLabel control={<Checkbox checked={this.state.notesOn} onChange={this.handleNotesChange}/>} label="Notes"/><br/>
                                    <FormControlLabel control={<Checkbox checked={true}/>} label="Photos"/><br/>
                                    <FormControlLabel control={<Checkbox checked={true}/>} label="Documents"/><br/>
                                    <FormControlLabel control={<Checkbox checked={true}/>} label="Videos"/><br/><br/>
