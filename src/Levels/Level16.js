  ...
  constructor(props) {
    ...
    this.state = {
      ...
      files: [
        ...
        {
          id: "level 16 file 3",
          name: "Spy Academy Application",
          type: "personal",
        },
        {
          id: "level 16 file 4",
          name: "Spy Academy Acceptance Letter",
          type: "academy",
        },
        ...
        {
          id: "level 16 file 10",
          name: "Interview Response Form",
          type: "academy",
        },
        {
          id: "level 16 file 11",
          name: "Agent Interview Response",
          type: "academy",
        },
        ...
        {
          id: "level 16 file 17",
          name: "Questions for the Academy",
          type: "personal",
        },
        {
          id: "level 16 file 18",
          name: "Mentor and Agent Pairings",
          type: "academy",
        },
        {
          id: "level 16 file 19",
          name: "Preliminary Training Schedule",
          type: "academy",
        },
        {
          id: "level 16 file 20",
      ...
      >
        <div className="drag-container">
          ...
          {this.state.isJewelShown && (
            <Jewel top="80%" handleFound={this.handleFound} />
          )}
        </div>
      </Level>
    );
