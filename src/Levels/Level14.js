...
export default function Level14(props) {
  ...
  return (
    <Level
      ...
      mission='log into the learning portal using the email "agent203@spyacademy.org" and password "password".'
      hintMessage="You may not have the right password. Try resetting it."
      dialogMessage="Your mission is complete! It is easy to forget passwords, but also easy to reset them. Most sites will email you a link to reset your password in a similar manner. Click the X to receive your next mission."
