...
export default function Level12(props) {
  ...
  return (
    <Level
      ...
      dialogMessage="Your mission is complete! Maps can be navigating by zooming in and out and clicking and dragging. Click the X to receive your next mission."
